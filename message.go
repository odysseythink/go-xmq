...
// Finish sends a FIN command to the xmqd which
// sent this message
...
// Touch sends a TOUCH command to the xmqd which
// sent this message
...
// Requeue sends a REQ command to the xmqd which
...
// RequeueWithoutBackoff sends a REQ command to the xmqd which
// sent this message, using the supplied delay.
//
